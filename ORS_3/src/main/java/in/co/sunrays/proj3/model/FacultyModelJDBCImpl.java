...
import in.co.sunrays.proj3.model.FacultyModelJDBCImpl;
/**
...
public class FacultyModelJDBCImpl implements FacultyModelInt {
     ...
     */
     public long add(FacultyDTO bean) throws ApplicationException, DuplicateRecordException {
		...
		FacultyDTO beanExist = findByLogin(bean.getEmailId());
		if (beanExist != null) { 
	 ...
	 * @throws DatabaseException
	 */
	public FacultyDTO findByLogin(String emailId) throws ApplicationException {
