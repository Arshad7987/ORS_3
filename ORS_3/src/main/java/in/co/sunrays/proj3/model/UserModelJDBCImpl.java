...
public class UserModelJDBCImpl implements UserModelInt {
    ...
    public long add(UserDTO dto) throws ApplicationException,
        ...
        try {
            ...
            pstmt.setInt(1, pk);
            pstmt.setLong(2, dto.getRoleId());
            pstmt.setString(3, dto.getRoleName());
            ...
            pstmt.setString(9, dto.getLogin());
    ...
    public UserDTO findByLogin(String login) throws ApplicationException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                dto.setLogin(rs.getString(9));
                dto.setPassword(rs.getString(10));
    ...
    public void update(UserDTO dto) throws ApplicationException,
        ...
        if (dtoExist != null && !(dtoExist.getId() == dto.getId())) {
        	System.out.println(dtoExist.getId()+"="+dto.getId());
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE ST_USER SET ROLE_ID,ROLE_NAME FIRST_NAME=?,LAST_NAME=?,GENDER=?,DOB=?,MOBILE_NO=?,LOGIN=?,PASSWORD=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
